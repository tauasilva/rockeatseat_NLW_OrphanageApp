        ...
        <form onSubmit={HandleSubmit} className="create-orphanage-form">
          <fieldset>
            ...
            <div className="input-block">
              ...
              <input multiple onChange={HandleSelectImage} type="file" id="image[]"></input>
            </div>
          </fieldset>
          ...
          <fieldset>
            ...
            <div className="input-block">
              ...
              <textarea value={instructions} onChange={event => setIntructions(event.target.value)} id="instructions" />
            </div>
